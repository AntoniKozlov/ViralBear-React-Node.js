                    ...
                    <Grid container item xs={12} lg={6} spacing={3}>
                        ...
                        <Grid item xs={12} className={classNames(classes.centeredContent, classes.flex)}>
                            <FormControlLabel
                                ...
                                label="I accept the"
                            />
                            <Link className={classes.link} to="/termsOfUse">Terms and Conditions</Link>
                        </Grid>
...
export default connect(mapStateToProps, mapDispatchToProps)(withSnackbar(SubmitVideoPage));
