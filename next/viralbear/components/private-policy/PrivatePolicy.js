...
import {useStyles} from './PrivatePolicy.module.styles';
                ...
                <Paper className={classes.paddingTopBottom}>
                    ...
                    <Grid item xs={8} className={classes.marginAuto}>
                        ...
                        <Typography variant="body1" gutterBottom>
                            ...
                            <Link className={classes.link} href="/"> www.viralbear.com</Link> Launchpad provides a
                        ...
                        <Typography variant="body1" gutterBottom>
                            ...
                            className={classes.link} href="/">www.viralbear.com</Link>, its operational host Launchpad
                            ...
                            on websites other than<Link className={classes.link} href="/"> www.viralbear.com</Link>,
                        ...
                        <Typography variant="body1" gutterBottom>
                            ...
                            <Link className={classes.link} href="/termsOfUse"> Terms of Use </Link>
                        ...
                        <Typography variant="body1" gutterBottom>
                            ...
                            <Link className={classes.link} href="/termsOfUse"> Terms of Use</Link> and Privacy Policy.
                        ...
                        <Typography variant="body1" gutterBottom>
                            ...
                            and<Link className={classes.link} href="/termsOfUse"> Terms of Use </Link>
                        ...
                        <Typography variant="body1" gutterBottom>
                            ...
                            changes to our <Link className={classes.link} href="/termsOfUse">Terms of Use</Link> and our
